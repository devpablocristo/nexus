"""Shared fixtures for nexus-operator integration tests.
...
def make_settings(**overrides: Any) -> Settings:
    ...
    defaults: dict[str, Any] = {
        "OPERATOR_APP_NAME": "nexus-operator-test",
        "OPERATOR_ENV": "test",
        "OPERATOR_PORT": 9999,
...
def build_app(
    ...
    application = FastAPI(title="nexus-operator-test", version="0.0.1-test", lifespan=lifespan)

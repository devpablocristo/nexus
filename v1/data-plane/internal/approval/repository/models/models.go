...
type PendingApproval struct {
	...
	ApprovalMode       string     `gorm:"not null;default:'standard'"`
	ApprovalGroupID    *uuid.UUID `gorm:"type:uuid"`
	ApprovalStep       int        `gorm:"not null;default:1"`
	ApprovalStepsTotal int        `gorm:"not null;default:1"`

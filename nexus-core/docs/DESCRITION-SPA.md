## Qué hace la app (`nexus-core`)

`nexus-core` es un **Agent Tool Gateway multi-tenant**: una capa de control para que **agentes de IA** (o cualquier caller) puedan **invocar herramientas/APIs HTTP** de forma **segura, gobernada, auditable y observable**.
